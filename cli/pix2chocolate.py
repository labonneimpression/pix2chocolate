...
if shutil.which("convert"):
    exitcode, output = subprocess.getstatusoutput('convert -rotate "90>" -background "#000000" -density 900 {input_file} {output_file}'.format(input_file=args.image, output_file=DEFAULT_DISPLACEMENT_TEXTURE_IMAGE))
    logging.info(output)
else:
